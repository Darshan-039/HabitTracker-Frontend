...
const HABITS = [
  ...
  { Icon: FaDumbbell, color: "#16a34a", orbit: "middle", delay: -16, reverse: true },
  // inner orbit
...
export default function OrbitingHabits() {
  ...
  const sunGradient = isDark
    ...
    : "radial-gradient(circle at 30% 25%, #ffffff, #dcfce7 45%, #bbf7d0 100%)";
  ...
  const sunIconColor = isDark ? "#bbf7d0" : "#166534";
  ...
  return (
    <div className="relative mx-auto w-[300px] h-[300px] sm:w-[400px] sm:h-[400px] lg:w-[460px] lg:h-[460px]">
      ...
      {STARS.map((s, i) => (
        <span
          key={i}
          className="absolute rounded-full bg-green-400/70 dark:bg-green-200/70"
          style={{
            top: s.top,
            left: s.left,
            width: s.size,
