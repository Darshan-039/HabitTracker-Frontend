  ...
  return (
    <div className="relative rounded-2xl p-5 glass overflow-hidden animate-slide-up">
      ...
      <div className="flex items-start gap-3 pr-6 relative">
        <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-green-400 to-green-600 text-white flex items-center justify-center shrink-0 shadow-lg shadow-green-500/30 animate-float">
          <Sun size={20} />
        </div>
        <div>
