      ...
      <div className="card p-4">
        <div className="flex flex-col md:flex-row gap-3 md:items-center">
          ...
          <select
            ...
            className="input md:w-52 appearance-none cursor-pointer"
          >
          ...
          <div className="inline-flex rounded-xl glass overflow-hidden text-sm">
            <button
              ...
              className={`px-3.5 py-2.5 font-medium transition ${!showArchived
            ...
            <button
              ...
              className={`px-3.5 py-2.5 font-medium transition border-l divider ${showArchived
                ? "bg-brand-500/15 text-brand-700 dark:text-brand-300"
                : "text-soft hover:bg-(--surface-hover)"
                }`}
            >
        ...
        <div className="space-y-2">
          {filtered.map((h) => {
            ...
            return (
              <div
                key={h._id}
                className={`card p-4 flex items-center gap-4 ${h.isArchived ? "opacity-70" : ""
                  }`}
              >
                <div
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-2 flex-wrap">
                    ...
                    {h.isArchived && (
                      <span className="chip bg-green-500/15 text-green-700 dark:text-green-300">
                        Archived
                      </span>
                    )}
                  </div>
                ...
                <div className="hidden sm:flex items-center gap-4 text-sm">
                  ...
                  >
                    <Flame
                      size={14}
                      className={current > 0 ? "text-green-500" : "text-faint"}
                    />
